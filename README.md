...
**Step05** `05_speciestree.py` This script performs species tree inference using exon trees generated by the `04_exon_phylogeny.py` script in Step04. Species tree inference is performed in ASTRAL v.5.7.8 (Mirarab et al., 2014, Zhang et al., 2018).  

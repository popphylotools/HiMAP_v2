...
**Part04** `04_exon_phylogeny.py` This script is intended to infer exon phylogenies following the steps: generates the alignment, determine the best-fit substitution model and reconstruct a maximum likelihood phylogeny.  
**Part05** `05_speciestree.py` This script performs species tree inference using exon trees generated by the `05_exon_phylogeny.py` script in Part04. Species tree inference is performed in ASTRAL v.5.7.8 (Mirarab et al., 2014, Zhang et al., 2018).  
...
## Installation
#### Python
Conda installer (Anaconda, Miniconda, Mamba)
